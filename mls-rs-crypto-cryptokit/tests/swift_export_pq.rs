...
//! The swift-mls format-2 export fixture for the deployed PQ suite
//! (GER-2433): a real `Group` on `CipherSuite::ML_KEM_768`, exported through
...
/// reconstructs (GER-2301 KAT-proven the byte form; the exporter's own
